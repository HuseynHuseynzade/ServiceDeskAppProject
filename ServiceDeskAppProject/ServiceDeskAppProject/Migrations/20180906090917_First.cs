        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedById1 = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cards_AspNetUsers_AddedById1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncidentStatus = table.Column<int>(nullable: false),
                    ProblemDescription = table.Column<string>(nullable: true),
                    TeamviewerId = table.Column<string>(nullable: false),
                    OperatorId = table.Column<string>(nullable: true),
                    OperatorReactDate = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidents_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelledDate = table.Column<DateTime>(nullable: false),
                    SelledById = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelledLicenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelledLicenses_Licenses_LicenseId",
                        column: x => x.LicenseId,
                        principalTable: "Licenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SelledLicenses_AspNetUsers_SelledById",
                        column: x => x.SelledById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelledLicenses_LicenseId",
                table: "SelledLicenses",
                column: "LicenseId");

            migrationBuilder.CreateIndex(
                name: "IX_SelledLicenses_SelledById",
                table: "SelledLicenses",
                column: "SelledById");
        }
